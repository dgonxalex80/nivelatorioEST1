...
```
**Figura 1.1**  *Carrera atletica* </br>
...
```
**Figura 1.1**  Tiempos de carrera en minutos </br>
...
```
**Figura 1.2**  Tiempos de carrera en minutos - Percentil 30 </br>
<sub>Fuente : Carrera La Luz Cali  </sub>
</center>
...
```
**Figura 1.3**  Tiempos de carrera en minutos - Percentil 75 </br>
<sub>Fuente : Carrera La Luz Cali  </sub>
</center>
...
```
**Figura 1.4**  Tiempos de carrera en minutos - Decil 2 y Decil 5</br>
<sub>Fuente : Carrera La Luz Cali  </sub>
</center>
...
```
**Figura 1.5**  Tiempos de carrera en minutos - Cuartiles: $Q_1$, $Q_2$  y $Q_3$</br>
<sub>Fuente : Carrera La Luz Cali  </sub>
</center>
