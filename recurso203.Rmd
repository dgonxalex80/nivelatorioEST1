...
Es el indicador de tendencia central más conocido y utilizado por si fácil interpretación y calculo. Consiste en sumar todos los valores de un conjunto de datos y dividirlos por el número de datos
...
Una empresa de transporte desea estimar la media de tiempo que se pueden tardar sus autos en un viaje de una ciudad A a una ciudad B. El tiempo empleado por un grupo de 3 de sus vehículos. Los tiempos registrados con respectivamente son 4.25, 3.75 y 5.25 horas ( tiempos equivalentes en escala decimal)
