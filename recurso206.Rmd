...
<sub>Fuente : enciclopedia.net</sub>
</div>
...
## <span style="color:#034a94">**Gráficos variables cualitativas**</span>

<br/>

### <span style="color:#034a94">**Gráfico de tortas**</span>
...
labs=paste(lbs, pct)
labs=paste(labs, "%", sep = " ") 
pie(t, labels=labs, main=" ",
col = paleta4)
```
<br/>
**Figura 1.12**  Participación eventos Medio Universitario </br>
</center>
...
barplot(ev, col=c("#ff5b00","#dcf600","#7dbd00","#659cef","#2956b2"), las=1, ylim = c(0,50))
```
<br/>
**Figura 1.13**  Evaluación proceso de inducción </br>
</center>

<br/><br/>

### <span style="color:#034a94">**Diagrama de barras con dos variables**</span>
...
barplot(counts, xlab="Número de cambios adelante ",col=c("#FFBF69","#034A94"),
legend = rownames(counts))
```
<br/>
**Figura 1.14** Numero de cambios adelante por Tipo de motor  </br>
</center>

<br/><br/><br/>

## <span style="color:#034a94">**Gráficas variables cualitativas**</span>
...
<center>
```{r, fig.height=5, echo=FALSE}
h1=hist(nf,  xlab = "nota", ylab="frecuencias absolutas", labels=TRUE, col="#034A94", ylim = c(0,30), las=1)
abline(v=3,col="#f6b915", lwd=2)
```
<br/>
**Figura 1.15**  Nota final de Estadística </br>
</center>
...
```{r, fig.height=5, echo=FALSE}
nf=c(4.1, 2.7, 3.1, 3.2, 3.0, 3.2, 2.0, 2.4, 1.6, 3.2, 3.1, 2.6, 2.0, 2.4, 2.8, 3.3, 4.0, 3.4, 3.0, 3.1, 2.7, 2.7, 3.0, 3.8, 3.2, 2.2, 3.5, 3.5, 3.8, 3.5, 3.9, 4.2, 4.3, 3.9, 3.2, 3.5, 3.5, 3.7, 4.1, 3.7, 3.5, 3.6, 3.2, 3.1, 3.4, 3.0, 3.0, 3.0, 2.7, 1.7, 3.6, 2.1, 2.4, 3.0, 3.1, 2.5, 2.5, 3.6, 2.2, 2.4, 3.1, 3.3, 2.7, 3.7, 3.0, 2.7, 3.0, 3.2, 3.1, 2.4, 3.0, 2.7, 2.5, 3.0, 3.0, 3.0, 3.2, 3.1, 3.8, 4.1, 3.7, 3.5, 3.0, 3.7, 3.7, 4.1, 3.7, 3.9, 3.7, 2.0)
plot(density(nf),  col="#034A94", lwd=4, las=1,
xlab="nota", ylab="densidad")
```
<br/>
**Figura 1.16**  Distribucion de las notas de Estadística,</br>
</center>
...
```
<br/>
**Figura 1.17**  Nota final Estadística </br>
</center>
...
plot(ed,nf,  ylim = c(0,5), xlab = "Edad (años)", ylab = "Nota final",col="#447270",pch=19,las=1)
grid()
```
<br/>
**Figura 1.18**  Edad vs Nota final Estadística </br>
</center>
...
<center>
```{r, fig.height=5, echo=FALSE}
plot(AirPassengers,  col="#034A94", lwd = 4, las=1, 
ylab="número de pasajeros", xlab="año")
```
<br/>
**Figura 1.19**  Numero de pasajeros por mes </br>
</center>
<br/><br/><br/>
