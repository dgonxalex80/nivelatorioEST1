...
<center>
**Tabla 1.1** <br/>
*Distribución de la ubicación de contagios de Covid-19 Colombia*
...
<center>
**Tabla 1.2** <br/>
*Evaluación del servicio de atención al cliente dic-2022*
...
<center>
**Tabla 1.3** <br/>
*Distribución de la ubicación por sexo de los contagiados de Covid-19 Colombia*
```{r, echo=FALSE, out.width="60%", fig.align = "center"}
knitr::include_graphics("img/tabla3.png")
```
<sub>
Fuente : Base Casos positivos de COVID-19 en Colombia. 17-10-2022</center>
</sub>
</center>
