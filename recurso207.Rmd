...
<center>
**Tabla 1.3** Distribución de población mundial por continente
```{r, echo=FALSE, out.width="50%", fig.align = "center"}
 knitr::include_graphics("img/tabla1a.png")
```
<sub>
...
<sup>Fuente: Encuesta se
<center>
**Tabla 1.4** Servicio de atención al cliente dic-2022
```{r, echo=FALSE, out.width="60%", fig.align = "center"}
knitr::include_graphics("img/tabla2a.png")
...
knitr::include_graphics("img/tabla3a.png")
```
</center>
