...
La siguiente tabla corresponde a la distribución de la población mundial a 2022  por continente, base que se encuentra disponible en la plataforma [Datos abiertos](https://www.datos.gov.co/browse?q=covid%20&sortBy=relevance)
...
La tabla permite visualizar la distribución de la población muncial por continente, resaltando que más de la mitad de la población mundial se ubica en Asia (59.2%). 
...
La tabla muestra que un 13.2% de los encuestados tienen una percepción no agradable sobre el servicio prestado por la cafeteria (muy regular y regular), mientras que un  86% tiene un concepto del servicio bueo a excelente.
...
La tabla permite observar la distribución de las calificaciones por lugar de residencia 
...
Al trabajar con la base de datos Covid-19 para Colombia se encontraron registros con el mismo valor pero que por su forma de escritura eran tomados como diferentes. 
